...
function getNavigationItems(_userRole: string | undefined, unreadCount: number, unseenGradedCount: number = 0): NavItemTuple[] {
  const allItems: NavItemTuple[] = [
    ...
    ['/homework', 'My Homework', ClipboardList, unseenGradedCount, ['student'], 'assignments-nav'],
    ...
    ['/curator/homeworks', 'Homework Performance', FileText, 0, ['curator'], 'homework-analytics-nav'],
